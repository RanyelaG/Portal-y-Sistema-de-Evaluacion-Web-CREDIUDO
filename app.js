...
var evaluar = require('./routers/evaluar.js')
var reporte_master = require('./routers/reporte_master.js')
...
app.use('/evaluar', evaluar);
app.use('/reporte_master', reporte_master);
